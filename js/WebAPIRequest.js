...
const apiBaseURL= "https://daisy-beneficial-seagull.glitch.me/";
...
function webAPI_allUsersInfo(successCallBack, errorCallBack) {
    return $.ajax({
        ...
        error: function(jqXHR) {  
            errorCallBack(jqXHR.status);
            console.log("webAPI_allUsersInfo - error");
        }
    })
}
...
function webAPI_GET_NEWS( id, successCallBack, errorCallBack) {
    $.ajax({
...
function webAPI_POST_NEWS( data , successCallBack, errorCallBack) {
    $.ajax({
        url: apiBaseURL + "/api/news",
        type: 'POST',
        headers: getBearerAuthorizationToken(),
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("webAPI_POST_NEWS - error");
        }
    });
}
...
function webAPI_PUT_NEWS(data, successCallBack, errorCallBack) {
    $.ajax({
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("webAPI_PUT_NEWS - error");
        }
    });
}
...
function webAPI_DELETE_NEWS( id, successCallBack, errorCallBack) {
    $.ajax({
        url: apiBaseURL + "/api/news" + "/" + id,
        contentType:'text/plain',
        type: 'DELETE',
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("webAPI_DELETE_NEWS - error");
        }
    });
}
...
function webAPI_GET_ALL_NEWS(queryString, successCallBack, errorCallBack){
    $.ajax({
        ...
        success: (data, status, xhr) => { 
            let ETag = xhr.getResponseHeader("ETag");
            successCallBack(data, ETag); 
            console.log("webAPI_GET_ALL_NEWS - success", data); 
            console.log(`ETag: ${ETag}`);
        },
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("webAPI_GET_ALL_NEWS - error");
        }
    });
}
function webAPI_HEAD_NEWS(successCallBack, errorCallBack){
    $.ajax({
        url: apiBaseURL + "/api/news",
        type: 'HEAD',
        contentType:'text/plain',
        ...
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
            console.log("webAPI_HEAD_NEWS - error");
        }
    });
}
